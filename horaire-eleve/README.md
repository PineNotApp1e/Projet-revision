# Projet-revision
Ce projet permettra de vérifier et réactiver ce qui a été travaillé en deuxième année

# Auteur : 
Giroud Nathanaël

# Procedure de creation de la base de donnée
1. Allez sur [phpmyadmin](http://localhost/phpmyadmin/index.php).
2. Puis sur importer
