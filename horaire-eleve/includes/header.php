...
function Menu($page): string
{
  ...
  <li class="nav-item">
    <a class="nav-link  ' . ($page == 'index' ? 'active' : '') . '" ' . ($page == 'index' ? 'aria-current="page"' : '') . ' href="' . ($page != 'index' ? '../' : '') . 'index.php">Home</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link ' . ($page == 'horaire' ? 'active' : '') . '" ' . ($page == 'horaire' ? 'aria-current="page"' : '') . ' href="' . ($page == 'index' ? 'pages/' : '') . 'horaire.php">Horaire</a>
  </li>
</ul>
</header>';
}
